...
<head>
    ...
    <title>Filsafat - Page Station</title>
    ...
    <div class="white-boxes">
        <div class="kategori">
            ...
            <div class="subkategori-container">
                <a href="filsafat/filsafat-agama.php" class="subkategori-box">Filsafat Agama</a>
                <a href="filsafat/filsafat-ilmu.php" class="subkategori-box">Filsafat Ilmu</a>
            </div>
        </div>
    </div>
</section>
