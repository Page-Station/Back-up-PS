...
<section class="content">
    ...
    <div class="search-bar">
        <form method="GET" action="filsafat-ilmu.php">
            <input type="text" name="search" placeholder="Cari Buku Filsafat Ilmu..." value="<?php echo htmlspecialchars($search); ?>">
