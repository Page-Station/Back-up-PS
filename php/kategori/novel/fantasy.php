...
// Ambil buku dari database yang kategori = Novel dan sub_category = Fantasy
...
<section class="content">
    <div class="search-bar">
        <input type="text" placeholder="Cari novel Fantasy...">
        ...
        <div class="kategori">
            ...
            <div class="book-grid">
                <?php if ($result_books->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p>Tidak ada buku Fantasy tersedia saat ini.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
