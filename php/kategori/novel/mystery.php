...
// Ambil buku dari database yang kategori = Novel dan sub_category = Mystery
...
<section class="content">
    <div class="search-bar">
        <input type="text" placeholder="Cari novel Mystery...">
        ...
        <div class="kategori">
            ...
            <div class="book-grid">
                <?php if ($result_books->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p>Tidak ada buku Mystery tersedia saat ini.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
