...
<section class="content">
    ...
    <div class="search-bar">
        ...
        <form method="GET" action="kisah-nabi.php">
            <input type="text" name="search" placeholder="Cari Buku Kisah Nabi..." value="<?php echo htmlspecialchars($search); ?>">
